...
source_datasets = {
    'chicago_speed_camera_violations.csv': 'https://data.cityofchicago.org/resource/hhkd-xvj4.csv', # https://data.cityofchicago.org/Transportation/Speed-Camera-Violations/hhkd-xvj4
    'nypd_complaint_data_historic.csv': 'https://data.cityofnewyork.us/resource/qgea-i56i.csv', # https://data.cityofnewyork.us/Public-Safety/NYPD-Complaint-Data-Historic/qgea-i56i
    'nyc_311_service_requests_2009.csv': 'https://data.cityofnewyork.us/resource/3rfa-3xsf.csv' # https://data.cityofnewyork.us/Social-Services/311-Service-Requests-for-2009/3rfa-3xsf
}
